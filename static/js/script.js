...
$(function () {
    drawAsterChart(data["A02"]["answer"]["Agency for Civil Registration"], suffix["A02"]);
    ...
    $("#agency-select").change(function () {
        ...
        displayChart(data[selected_question]["answer"][selected_agency], window.suffix[selected_question]);
    });
